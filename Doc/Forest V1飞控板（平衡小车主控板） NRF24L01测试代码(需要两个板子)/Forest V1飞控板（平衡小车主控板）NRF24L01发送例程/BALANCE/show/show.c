...
void oled_show(void)
{
  	...
  	//=============显示编码器2=======================//		
		...
		if(Angle_Balance<0)		OLED_ShowNumber(75,40,Angle_Balance+360,3,12);
		else					        OLED_ShowNumber(75,40,Angle_Balance,3,12);
			//=============显示角度=======================//
			                      OLED_ShowString(0,50,"Angle_Y");
		if(Angle_Y<0)		OLED_ShowNumber(75,50,Angle_Y+360,3,12);
		else					        OLED_ShowNumber(75,50,Angle_Y,3,12);
		//=============刷新=======================//
		OLED_Refresh_Gram();	
	}
/**************************************************************************
